      ...
      <div className="max-w-[1400px] mx-auto px-6 md:px-12">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
          {steps.map((step) => (
            <div
              key={step.number}
              className="group relative bg-[#faf5f5] border border-gray-200 rounded-2xl overflow-hidden h-full flex flex-col"
            >
              ...
              <div className="p-6 flex flex-col grow relative z-20">
                ...
                {/* Description */}
                <p className="font-hanken text-sm md:text-base text-brand-black/70 leading-relaxed">
                  {step.description}
                </p>
              </div>
