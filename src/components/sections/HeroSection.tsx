    ...
    <section className="relative h-screen bg-brand-black overflow-hidden pt-24">
      <div className="relative flex flex-col lg:flex-row h-full">
        ...
        <div className="relative hidden lg:block lg:w-[50%] h-screen">
          ...
          <div className="absolute top-[15%] right-[30%] bg-amber rounded-3xl px-7 py-5 shadow-2xl z-10">
          ...
          {/* £0 Broker Fees - Right */}
          <div className="absolute top-[26%] right-[40%] bg-remigo-red rounded-3xl px-7 py-5 shadow-2xl z-10">
