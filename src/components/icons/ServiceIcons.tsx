...
export const RemortgageIcon = () => (
  <div className="w-full aspect-4/3 bg-brand-white rounded-xl border border-gray-200 p-4 overflow-hidden relative">
    ...
    <div className="space-y-2.5">
      ...
      <motion.div
        className="bg-white border border-gray-300 rounded-lg p-2.5 flex justify-between items-center relative overflow-hidden"
        initial={{ x: -30, opacity: 0 }}
        animate={{ x: 0, opacity: 1 }}
        transition={{ duration: 0.6, delay: 0.5, repeat: Infinity, repeatDelay: 4 }}
      >
        <motion.div
          className="absolute inset-0 bg-linear-to-r from-transparent via-brand-black/5 to-transparent"
          initial={{ x: '-100%' }}
          animate={{ x: '200%' }}
          transition={{ duration: 1.5, delay: 1, repeat: Infinity, repeatDelay: 4 }}
        />
        <div className="text-[9px] text-brand-black/70 font-medium relative z-10">New Rate</div>
        <div className="text-sm font-bold text-brand-black relative z-10">3.89%</div>
      </motion.div>

      <motion.div
        className="bg-remigo-red/5 border border-remigo-red/10 rounded-lg p-2.5 flex justify-between items-center"
        initial={{ scale: 0.9, opacity: 0 }}
        animate={{ scale: 1, opacity: 1 }}
        transition={{ duration: 0.5, delay: 0.8, repeat: Infinity, repeatDelay: 4 }}
      >
        <div className="text-[9px] text-brand-black font-medium">Monthly Savings</div>
        <div className="text-sm font-bold text-brand-black">£240</div>
      </motion.div>
    </div>
  </div>
);
  ...
  <div className="w-full aspect-4/3 bg-brand-white rounded-xl border border-gray-200 p-4 overflow-hidden relative">
    ...
    >
      ...
      <div className="h-16 bg-white relative overflow-hidden">
        <motion.div
          className="absolute inset-0 bg-linear-to-br from-gray-200/40 to-gray-100/40"
          initial={{ scale: 1.2 }}
          animate={{ scale: 1 }}
      ...
      <div className="p-2.5 space-y-2">
        <motion.div
          className="h-1.5 bg-gray-200 rounded-full w-2/3"
          initial={{ scaleX: 0 }}
          animate={{ scaleX: 1 }}
        ...
        />
        <motion.div
          className="h-1 bg-gray-200 rounded-full w-1/2"
          initial={{ scaleX: 0 }}
          animate={{ scaleX: 1 }}
        ...
        >
          <span className="text-[11px] font-bold text-brand-black">£250,000</span>
          <span className="text-[8px] px-2 py-0.5 bg-green-500/10 text-green-600 rounded-full border border-green-500/20">Approved</span>
        </motion.div>
      </div>
    </motion.div>
  </div>
...
export const SelfEmployedIcon = () => (
  <div className="w-full aspect-4/3 bg-brand-white rounded-xl border border-gray-200 p-4 overflow-hidden relative">
      ...
      {['SA302 Tax Return', 'Company Accounts', 'Bank Statements'].map((doc, i) => (
        ...
        >
          <div className="flex items-center gap-2 flex-1">
            ...
            <span className="text-[9px] text-brand-black/70 font-medium truncate">{doc}</span>
          </div>
    ...
    {/* Status indicator */}
    <motion.div
      className="mt-3 flex items-center justify-between bg-white border border-gray-300 rounded-lg p-2"
...
export const ProtectionIcon = () => (
  <div className="w-full aspect-4/3 bg-brand-white rounded-xl border border-gray-200 p-4 overflow-hidden relative">
    ...
    <div className="space-y-2.5">
      {/* Life Cover - Active */}
      <motion.div
        className="bg-white border border-gray-300 rounded-lg p-2.5"
        initial={{ opacity: 0, y: 10 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.5, delay: 0.2, repeat: Infinity, repeatDelay: 4 }}
      >
        <div className="flex items-center justify-between mb-2">
          <span className="text-[9px] text-brand-black font-medium">Life Cover</span>
          <motion.div
            className="relative w-8 h-4 bg-remigo-red/10 rounded-full border border-remigo-red/20 cursor-pointer flex items-center"
            initial={{ backgroundColor: 'rgba(219,59,59,0.05)' }}
            animate={{ backgroundColor: 'rgba(219,59,59,0.1)' }}
            transition={{ duration: 0.3, delay: 0.5, repeat: Infinity, repeatDelay: 4 }}
          >
            <motion.div
              className="absolute w-3 h-3 bg-remigo-red rounded-full shadow-lg"
              initial={{ left: '2px' }}
        ...
        <motion.div
          className="text-[11px] font-bold text-brand-black"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
      ...
      {/* Premium display */}
      <motion.div
        className="flex items-center justify-between bg-white border border-gray-300 rounded-lg p-2.5 mt-3"
